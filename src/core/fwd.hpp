...
template <typename _Float> struct CoreAliases {
  ...
  using QuatF = em::Quaternion<Float>;
  using QuatD = em::Quaternion<Float64>;
  ...
  using AffineTransform3f = AffineTransform<Point<Float, 3>>;
  using AffineTransform4f = AffineTransform<Point<Float, 4>>;
  using AffineTransform3d = AffineTransform<Point<Float64, 3>>;
  using AffineTransform4d = AffineTransform<Point<Float64, 4>>;
  using ProjectiveTransform3f = ProjectiveTransform<Point<Float, 3>>;
  using ProjectiveTransform4f = ProjectiveTransform<Point<Float, 4>>;
  using ProjectiveTransform3d = ProjectiveTransform<Point<Float64, 3>>;
  using ProjectiveTransform4d = ProjectiveTransform<Point<Float64, 4>>;
};
NAMESPACE_END(eldr)
...
#define EL_IMPORT_CORE_TYPES_PREFIX(Float_, prefix)                            \
  ...
  using prefix##QuatF = typename prefix##CoreAliases::QuatF;                   \
  using prefix##QuatD = typename prefix##CoreAliases::QuatD;                   \
  ...
  using prefix##AffineTransform3f =                                            \
    typename prefix##CoreAliases::AffineTransform3f;                           \
  using prefix##AffineTransform4f =                                            \
    typename prefix##CoreAliases::AffineTransform4f;                           \
  using prefix##AffineTransform3d =                                            \
    typename prefix##CoreAliases::AffineTransform3d;                           \
  using prefix##AffineTransform4d =                                            \
    typename prefix##CoreAliases::AffineTransform4d;                           \
  using prefix##ProjectiveTransform3f =                                        \
    typename prefix##CoreAliases::ProjectiveTransform3f;                       \
  using prefix##ProjectiveTransform4f =                                        \
    typename prefix##CoreAliases::ProjectiveTransform4f;                       \
  using prefix##ProjectiveTransform3d =                                        \
    typename prefix##CoreAliases::ProjectiveTransform3d;                       \
  using prefix##ProjectiveTransform4d =                                        \
    typename prefix##CoreAliases::ProjectiveTransform4d;
...
#define EL_IMPORT_CORE_TYPES_SCALARF() EL_IMPORT_CORE_TYPES_PREFIX(float, )
