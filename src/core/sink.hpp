...
template <typename T> struct is_valid_threading_policy : std::false_type {};
template <typename T>
constexpr bool is_valid_threading_policy_v{
  is_valid_threading_policy<T>::value
};
template <>
struct is_valid_threading_policy<SingleThreaded> : std::true_type {};
template <> struct is_valid_threading_policy<MultiThreaded> : std::true_type {};
...
{
  static_assert(detail::is_valid_threading_policy_v<TPolicy>,
